        ...
        <div className="bg-surface rounded-2xl p-6 sm:p-8 shadow-sm border border-border/40">
          ...
          <div
            ...
            className={`
              ...
              ${isDragging 
                ? 'border-accent bg-bg' 
                : 'border-border/60 hover:border-muted hover:bg-bg/50'
              }
            `}
          >
            {selectedFile ? (
              <>
                <FileText className="w-8 h-8 text-textSecondary mb-3" />
              ...
              <>
                <UploadIcon className="w-8 h-8 text-muted mb-3" />
          ...
          <div className="mt-5 space-y-3">
            ...
            <button
              ...
              className={`
                ...
                transition-all duration-150
                ${isLoading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-border/50'}
              `}
            >
              Use Sample Data
            </button>
